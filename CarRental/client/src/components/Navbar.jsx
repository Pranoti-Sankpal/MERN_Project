...
const Navbar = ({setShowLogin}) => {
    ...
    return (
        <div className={`flex items-center justify-between px-6 md:px-16 lg:px-24 xl:px-32 py-4 text-gray-600 relative transition-all ${location.pathname === "/" && "bg-light"}`}>
            ...
            <div className={`flex flex-col sm:flex-row items-start sm:items-center gap-6 sm:gap-8
                ...
                right-0 max-sm:p-4 transition-all duration-300 z-50
                ...
                <div className='flex max-sm:flex-call items-start sm:items-center gap-6'>
